...
- [x] 05-06-PLAN.md — Gap closure: middleware /library redirect, urgency sort order, seed data claim for both roles
- [x] 05-07-PLAN.md — Gap closure: client-side demand board filtering/sorting, optimistic upvotes, compact metric cards
...
| 5. Demand Board and Dashboard | 7/7 | In Progress|  |
